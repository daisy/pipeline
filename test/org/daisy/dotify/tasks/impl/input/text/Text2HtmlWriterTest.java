...
public class Text2HtmlWriterTest {

	public Text2HtmlWriterTest() {
	}
	...
	public void testTask() throws IOException, TransformerException {
		...
		Text2HtmlWriter fw = new Text2HtmlWriter(is, os, "utf-8");
		fw.setRootLang("en");
		fw.parse();
		FileCompare fc = new FileCompare();
		assertTrue("File not equal", fc.compareXML(new FileInputStream(f), this.getClass().getResourceAsStream("resource-files/expected.html")));
	}
