...
$(TARGET_DIR)/state/assembly/modified-since-release_ : assembly/pom.xml \
	...
	$(TARGET_DIR)/state/modules/dtbook-to-latex/modified-since-release \
	...
	$(TARGET_DIR)/state/modules/pipeline1-adapter/modified-since-release \
...
assembly/.compile-dependencies : \
	...
	$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-latex/1.0.0-SNAPSHOT/dtbook-to-latex-1.0.0-SNAPSHOT.jar \
...
assembly/.release : \
	...
	$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-latex/1.0.0/dtbook-to-latex-1.0.0.jar \
