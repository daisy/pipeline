modules/daisy202-to-mp3/VERSION := 1.1.10-SNAPSHOT
...
$(TARGET_DIR)/state/modules/daisy202-to-mp3/modified-since-release_ : modules/daisy202-to-mp3/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy202-to-mp3/1.1.10-SNAPSHOT/daisy202-to-mp3-1.1.10-SNAPSHOT.pom : modules/daisy202-to-mp3/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy202-to-mp3/1.1.10-SNAPSHOT/daisy202-to-mp3-1.1.10-SNAPSHOT% : modules/daisy202-to-mp3/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/daisy202-to-mp3/.compile-dependencies : \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy202-to-mp3/1.1.10/daisy202-to-mp3-1.1.10.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy202-to-mp3/1.1.10/daisy202-to-mp3-1.1.10-% : modules/daisy202-to-mp3/.release
	+//
...
modules/daisy202-to-mp3/.release : \
