modules/asciimath-utils/VERSION := 2.0.2-SNAPSHOT
...
$(TARGET_DIR)/state/modules/asciimath-utils/modified-since-release_ : modules/asciimath-utils/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/asciimath-utils/2.0.2-SNAPSHOT/asciimath-utils-2.0.2-SNAPSHOT.pom : modules/asciimath-utils/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/asciimath-utils/2.0.2-SNAPSHOT/asciimath-utils-2.0.2-SNAPSHOT% : modules/asciimath-utils/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/asciimath-utils/.compile-dependencies : \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/asciimath-utils/2.0.2/asciimath-utils-2.0.2-% : modules/asciimath-utils/.release
	+//
...
modules/asciimath-utils/.release : \
