modules/tts-adapter-azure/VERSION := 1.1.5-SNAPSHOT
...
$(TARGET_DIR)/state/modules/tts-adapter-azure/modified-since-release_ : modules/tts-adapter-azure/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-azure/1.1.5-SNAPSHOT/tts-adapter-azure-1.1.5-SNAPSHOT.pom : modules/tts-adapter-azure/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-azure/1.1.5-SNAPSHOT/tts-adapter-azure-1.1.5-SNAPSHOT% : modules/tts-adapter-azure/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/tts-adapter-azure/.compile-dependencies : \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-azure/1.1.5/tts-adapter-azure-1.1.5-% : modules/tts-adapter-azure/.release
	+//
...
modules/tts-adapter-azure/.release : \
