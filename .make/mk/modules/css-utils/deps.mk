modules/css-utils/VERSION := 9.0.1-SNAPSHOT
...
$(TARGET_DIR)/state/modules/css-utils/modified-since-release_ : modules/css-utils/pom.xml $(TARGET_DIR)/state/modules/parent/modified-since-release
	mkdirs("$(dir $@)"); \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/css-utils/9.0.1-SNAPSHOT/css-utils-9.0.1-SNAPSHOT.pom : modules/css-utils/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/css-utils/9.0.1-SNAPSHOT/css-utils-9.0.1-SNAPSHOT% : modules/css-utils/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/css-utils/.compile-dependencies : $(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/modules-parent/1.15.6-SNAPSHOT/modules-parent-1.15.6-SNAPSHOT.pom
modules/css-utils/.test-dependencies :

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/css-utils/9.0.1/css-utils-9.0.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/css-utils/9.0.1/css-utils-9.0.1-% : modules/css-utils/.release
	+//
...
modules/css-utils/.release : $(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/modules-parent/1.15.6/modules-parent-1.15.6.pom
