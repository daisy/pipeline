modules/daisy3-to-epub3/VERSION := 3.1.6-SNAPSHOT
...
$(TARGET_DIR)/state/modules/daisy3-to-epub3/modified-since-release_ : modules/daisy3-to-epub3/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy3-to-epub3/3.1.6-SNAPSHOT/daisy3-to-epub3-3.1.6-SNAPSHOT.pom : modules/daisy3-to-epub3/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy3-to-epub3/3.1.6-SNAPSHOT/daisy3-to-epub3-3.1.6-SNAPSHOT% : modules/daisy3-to-epub3/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/daisy3-to-epub3/.compile-dependencies : \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy3-to-epub3/3.1.6/daisy3-to-epub3-3.1.6.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy3-to-epub3/3.1.6/daisy3-to-epub3-3.1.6-% : modules/daisy3-to-epub3/.release
	+//
...
modules/daisy3-to-epub3/.release : \
