modules/daisy3-to-mp3/VERSION := 1.2.11-SNAPSHOT
...
$(TARGET_DIR)/state/modules/daisy3-to-mp3/modified-since-release_ : modules/daisy3-to-mp3/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy3-to-mp3/1.2.11-SNAPSHOT/daisy3-to-mp3-1.2.11-SNAPSHOT.pom : modules/daisy3-to-mp3/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy3-to-mp3/1.2.11-SNAPSHOT/daisy3-to-mp3-1.2.11-SNAPSHOT% : modules/daisy3-to-mp3/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/daisy3-to-mp3/.compile-dependencies : \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy3-to-mp3/1.2.11/daisy3-to-mp3-1.2.11.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/daisy3-to-mp3/1.2.11/daisy3-to-mp3-1.2.11-% : modules/daisy3-to-mp3/.release
	+//
