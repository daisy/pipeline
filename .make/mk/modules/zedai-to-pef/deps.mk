modules/zedai-to-pef/VERSION := 7.1.1-SNAPSHOT
...
$(TARGET_DIR)/state/modules/zedai-to-pef/modified-since-release_ : modules/zedai-to-pef/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/zedai-to-pef/7.1.1-SNAPSHOT/zedai-to-pef-7.1.1-SNAPSHOT.pom : modules/zedai-to-pef/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/zedai-to-pef/7.1.1-SNAPSHOT/zedai-to-pef-7.1.1-SNAPSHOT% : modules/zedai-to-pef/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/zedai-to-pef/.compile-dependencies : \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/zedai-to-pef/7.1.1/zedai-to-pef-7.1.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/braille/zedai-to-pef/7.1.1/zedai-to-pef-7.1.1-% : modules/zedai-to-pef/.release
	+//
