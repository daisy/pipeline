modules/dtbook-to-daisy3/VERSION := 4.1.1-SNAPSHOT
...
$(TARGET_DIR)/state/modules/dtbook-to-daisy3/modified-since-release_ : modules/dtbook-to-daisy3/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-daisy3/4.1.1-SNAPSHOT/dtbook-to-daisy3-4.1.1-SNAPSHOT.pom : modules/dtbook-to-daisy3/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-daisy3/4.1.1-SNAPSHOT/dtbook-to-daisy3-4.1.1-SNAPSHOT% : modules/dtbook-to-daisy3/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/dtbook-to-daisy3/.compile-dependencies : \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-daisy3/4.1.1/dtbook-to-daisy3-4.1.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-to-daisy3/4.1.1/dtbook-to-daisy3-4.1.1-% : modules/dtbook-to-daisy3/.release
	+//
...
modules/dtbook-to-daisy3/.release : \
