modules/tts-adapter-osx/VERSION := 3.2.2-SNAPSHOT
...
$(TARGET_DIR)/state/modules/tts-adapter-osx/modified-since-release_ : modules/tts-adapter-osx/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-osx/3.2.2-SNAPSHOT/tts-adapter-osx-3.2.2-SNAPSHOT.pom : modules/tts-adapter-osx/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-osx/3.2.2-SNAPSHOT/tts-adapter-osx-3.2.2-SNAPSHOT% : modules/tts-adapter-osx/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/tts-adapter-osx/.compile-dependencies : \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-osx/3.2.2/tts-adapter-osx-3.2.2-% : modules/tts-adapter-osx/.release
	+//
...
modules/tts-adapter-osx/.release : \
