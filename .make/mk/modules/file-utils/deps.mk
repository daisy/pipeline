modules/file-utils/VERSION := 5.0.2-SNAPSHOT
...
$(TARGET_DIR)/state/modules/file-utils/modified-since-release_ : modules/file-utils/pom.xml $(TARGET_DIR)/state/modules/parent/modified-since-release
	mkdirs("$(dir $@)"); \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/file-utils/5.0.2-SNAPSHOT/file-utils-5.0.2-SNAPSHOT.pom : modules/file-utils/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/file-utils/5.0.2-SNAPSHOT/file-utils-5.0.2-SNAPSHOT% : modules/file-utils/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/file-utils/.compile-dependencies : $(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/modules-parent/1.15.6-SNAPSHOT/modules-parent-1.15.6-SNAPSHOT.pom
modules/file-utils/.test-dependencies :

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/file-utils/5.0.2/file-utils-5.0.2.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/file-utils/5.0.2/file-utils-5.0.2-% : modules/file-utils/.release
	+//
...
modules/file-utils/.release : $(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/modules-parent/1.15.6/modules-parent-1.15.6.pom
