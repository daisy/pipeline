modules/epub3-to-html/VERSION := 1.0.2-SNAPSHOT
...
$(TARGET_DIR)/state/modules/epub3-to-html/modified-since-release_ : modules/epub3-to-html/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub3-to-html/1.0.2-SNAPSHOT/epub3-to-html-1.0.2-SNAPSHOT.pom : modules/epub3-to-html/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub3-to-html/1.0.2-SNAPSHOT/epub3-to-html-1.0.2-SNAPSHOT% : modules/epub3-to-html/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/epub3-to-html/.compile-dependencies : \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/epub3-to-html/1.0.2/epub3-to-html-1.0.2-% : modules/epub3-to-html/.release
	+//
