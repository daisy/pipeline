modules/tts-adapter-cereproc/VERSION := 1.1.10-SNAPSHOT
...
$(TARGET_DIR)/state/modules/tts-adapter-cereproc/modified-since-release_ : modules/tts-adapter-cereproc/pom.xml \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-cereproc/1.1.10-SNAPSHOT/tts-adapter-cereproc-1.1.10-SNAPSHOT.pom : modules/tts-adapter-cereproc/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-cereproc/1.1.10-SNAPSHOT/tts-adapter-cereproc-1.1.10-SNAPSHOT% : modules/tts-adapter-cereproc/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
modules/tts-adapter-cereproc/.compile-dependencies : \
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-cereproc/1.1.10/tts-adapter-cereproc-1.1.10.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/tts-adapter-cereproc/1.1.10/tts-adapter-cereproc-1.1.10-% : modules/tts-adapter-cereproc/.release
	+//
...
modules/tts-adapter-cereproc/.release : \
