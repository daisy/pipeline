modules/scripts/dtbook-validator/VERSION := 3.1.1-SNAPSHOT
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-validator/3.1.1-SNAPSHOT/dtbook-validator-3.1.1-SNAPSHOT.pom : modules/scripts/dtbook-validator/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-validator/3.1.1-SNAPSHOT/dtbook-validator-3.1.1-SNAPSHOT% : modules/scripts/dtbook-validator/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-validator/3.1.1/dtbook-validator-3.1.1.% \
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/modules/dtbook-validator/3.1.1/dtbook-validator-3.1.1-% : modules/scripts/dtbook-validator/.release
	+//
