utils/build-utils/modules-test-helper/VERSION := 3.0.0
...
$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/build/modules-test-helper/3.0.0/modules-test-helper-3.0.0.pom : utils/build-utils/modules-test-helper/.install.pom | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);

$(MVN_LOCAL_REPOSITORY)/org/daisy/pipeline/build/modules-test-helper/3.0.0/modules-test-helper-3.0.0% : utils/build-utils/modules-test-helper/.install% | .group-eval
	+$(EVAL) if (new File("$@").exists()) touch("$@"); else exit(1);
...
utils/build-utils/modules-test-helper/.install.pom : %/.install.pom : | %/.compile-dependencies %/.test-dependencies
...
utils/build-utils/modules-test-helper/.install : %/.install : | %/.compile-dependencies %/.test-dependencies
...
utils/build-utils/modules-test-helper/.install-doc : %/.install-doc : | %/.compile-dependencies %/.test-dependencies
