...
public class NarManager {
  ...
  public final void unpackAttachedNars(final List/* <NarArtifacts> */narArtifacts,
      ...
      final File unpackDir, boolean process) throws MojoExecutionException, MojoFailureException {
    ...
    for (final Object dependency1 : dependencies) {
      ...
      layout.unpackNar(unpackDir, archiverManager, file, os, this.linkerName, this.defaultAOL, process);
    }
  }
}
