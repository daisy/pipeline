...
public class EvenSizeVolumeSplitterCalculatorTest {
    ...
    public void volumeNumber() {
        ...
        for (int j = 1; j < i; j++) {
            ...
            assertEquals(
                "Assert that sheet " + j + " is in the right volume.",
                vol,
                ssd.getVolumeForSheet(j)
            );
        }
    }
    ...
    public void volumeCount() {
        ...
        EvenSizeVolumeSplitterCalculator ssd = new EvenSizeVolumeSplitterCalculator(i, 49);
        assertTrue(
            "Assert that number of volumes is correct: " + ssd.getVolumeCount(),
            ssd.getVolumeCount() == 10
        );
    }
