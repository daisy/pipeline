...
public class ObflWsXsltTest {
    private static final Logger logger = Logger.getLogger(ObflWsXsltTest.class.getCanonicalName());

    @Test
    public void testWsNormalizer_01() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-01.xml",
            "resource-files/ws-test-expected-01.xml",
            "01",
            false
        );
    ...
    public void testWsNormalizer_02() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-02.xml",
            "resource-files/ws-test-expected-02.xml",
            "02",
            false
        );
    ...
    public void testWsNormalizer_03() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-03.xml",
            "resource-files/ws-test-expected-03.xml",
            "03",
            false
        );
    ...
    public void testWsNormalizer_04() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-04.xml",
            "resource-files/ws-test-expected-04.xml",
            "04",
            false
        );
    ...
    public void testWsNormalizer_05() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-05.xml",
            "resource-files/ws-test-expected-05.xml",
            "05",
            false
        );
    ...
    public void testWsNormalizer_06() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-06.xml",
            "resource-files/ws-test-expected-06.xml",
            "06",
            false
        );
    ...
    public void testWsNormalizer_07() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-07.xml",
            "resource-files/ws-test-expected-07.xml",
            "07",
            false
        );
    ...
    public void testWsNormalizer_08() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-08.xml",
            "resource-files/ws-test-expected-08.xml",
            "08",
            false
        );
    ...
    public void testWsNormalizer_09() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-09.xml",
            "resource-files/ws-test-expected-09.xml",
            "09",
            false
        );
    ...
    public void testWsNormalizer_10() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-10.xml",
            "resource-files/ws-test-expected-10.xml",
            "10",
            false
        );
    ...
    public void testWsNormalizer_11() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-11.xml",
            "resource-files/ws-test-expected-11.xml",
            "11",
            false
        );
    ...
    public void testWsNormalizer_12() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-12.xml",
            "resource-files/ws-test-expected-12.xml",
            "12",
            false
        );
    ...
    public void testWsNormalizer_13() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-13.xml",
            "resource-files/ws-test-expected-13.xml",
            "13",
            false
        );
        assertTrue("Compare (Before/After) failed at byte: " + ret, ret == -1);
    ...
    public void testWsNormalizer_14() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-14.xml",
            "resource-files/ws-test-expected-14.xml",
            "14",
            false
        );
    ...
    public void testWsNormalizer_15() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-15.xml",
            "resource-files/ws-test-expected-15.xml",
            "15",
            false
        );
        assertTrue("Compare (Item) failed at byte: " + ret, ret == -1);
    ...
    public void testWsNormalizer_16() throws IOException, XMLStreamException {
        int ret = testWsNormalizer(
            "resource-files/ws-test-input-16.xml",
            "resource-files/ws-test-expected-16.xml",
            "16",
            false
        );
        assertTrue("Compare (Item) failed at byte: " + ret, ret == -1);
    ...
    public int testWsNormalizer(
        ...
        OBFLWsNormalizer t = new OBFLWsNormalizer(
            inFactory.createXMLEventReader(instream),
        ...
        try {
            ...
            logger.throwing(ObflWsXsltTest.class.getName(), "testWsNormalizer", e);
        }
        ...
        if (keep && normalizedFile.isFile()) {
            logger.info(normalizedFile.getAbsolutePath());
        }
