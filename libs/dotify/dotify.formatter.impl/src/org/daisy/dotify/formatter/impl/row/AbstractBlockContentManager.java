...
public abstract class AbstractBlockContentManager implements BlockStatistics {
    ...
    protected AbstractBlockContentManager(
        int flowWidth,
        ...
        this.minWidth = minWidth ==
            null ?
            flowWidth -
            margins.getLeftMargin().getContent().length() -
            margins.getRightMargin().getContent().length() :
            minWidth;
    }
    ...
    protected AbstractBlockContentManager(AbstractBlockContentManager template) {
        ...
        // TODO: fcontext is mutable, but mutating is related to DOM creation,
        // and we assume for now that DOM creation is NOT going on when rendering has begun.
