	...
	public static class ComparatorBuilder {
		...
		public Comparator<FactoryProperties> build() {
			...
			return (arg0, arg1) -> {
				switch (field) {
				case DESCRIPTION:
					return (order==SortOrder.UP?1:-1)*arg0.getDescription().compareTo(arg1.getDescription());
				case IDENTIFIER:
					return (order==SortOrder.UP?1:-1)*arg0.getIdentifier().compareTo(arg1.getIdentifier());
				case DISPLAY_NAME: default:
					return (order==SortOrder.UP?1:-1)*arg0.getDisplayName().compareTo(arg1.getDisplayName());
				}
			};
		}
	}
