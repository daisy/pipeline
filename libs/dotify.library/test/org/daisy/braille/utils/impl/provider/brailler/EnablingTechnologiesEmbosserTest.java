...
public class EnablingTechnologiesEmbosserTest {
    ...
    private static EnablingTechnologiesEmbosser ra = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.ROMEO_ATTACHE");
    private static EnablingTechnologiesEmbosser rap = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.ROMEO_ATTACHE_PRO");
    private static EnablingTechnologiesEmbosser r25 = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.ROMEO_25");
    private static EnablingTechnologiesEmbosser rp50 = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.ROMEO_PRO_50");
    private static EnablingTechnologiesEmbosser rpln = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.ROMEO_PRO_LE_NARROW");
    private static EnablingTechnologiesEmbosser rplw = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.ROMEO_PRO_LE_WIDE");
    private static EnablingTechnologiesEmbosser t = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.THOMAS");
    private static EnablingTechnologiesEmbosser tp = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.THOMAS_PRO");
    private static EnablingTechnologiesEmbosser m = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.MARATHON");
    private static EnablingTechnologiesEmbosser et = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.ET");
    private static EnablingTechnologiesEmbosser jp = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.JULIET_PRO");
    private static EnablingTechnologiesEmbosser jp60 = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.JULIET_PRO_60");
    private static EnablingTechnologiesEmbosser jc = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.JULIET_CLASSIC");
    private static EnablingTechnologiesEmbosser bm = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.BOOKMAKER");
    private static EnablingTechnologiesEmbosser be100 = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.BRAILLE_EXPRESS_100");
    private static EnablingTechnologiesEmbosser be150 = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.BRAILLE_EXPRESS_150");
    private static EnablingTechnologiesEmbosser bp = (EnablingTechnologiesEmbosser)
            ec.get("com_brailler.EnablingTechnologiesEmbosserProvider.EmbosserType.BRAILLE_PLACE");

    private static PaperCatalog pc = PaperCatalog.newInstance();
    private static PageFormat a4 = new SheetPaperFormat(
    ...
    public void testEmbosserWriter() throws IOException,
        ...
        FileIO.copy(
            this.getClass().getResourceAsStream("resource-files/thomas_single_sided.prn"),
        ...
        FileIO.copy(
            this.getClass().getResourceAsStream("resource-files/juliet_pro_single_sided.prn"),
            new FileOutputStream(prn2)
        );
        new PEFConverterFacade(EmbosserCatalog.newInstance()).parsePefFile(pef, builder.build());
        try (InputStream is2 = new FileInputStream(prn2)) {
        ...
        FileIO.copy(
            this.getClass().getResourceAsStream("resource-files/juliet_pro_double_sided.prn"),
            new FileOutputStream(prn2)
        );
        new PEFConverterFacade(EmbosserCatalog.newInstance()).parsePefFile(pef, builder.build());
        try (InputStream is2 = new FileInputStream(prn2)) {
