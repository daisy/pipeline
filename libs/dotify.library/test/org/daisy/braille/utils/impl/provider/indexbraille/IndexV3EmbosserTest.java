...
public class IndexV3EmbosserTest {
    ...
    private static IndexV3Embosser index_everest = (IndexV3Embosser)
            ec.get("com_indexbraille.IndexEmbosserProvider.EmbosserType.INDEX_EVEREST_D_V3");
    private static IndexV3Embosser index_basic_s = (IndexV3Embosser)
            ec.get("com_indexbraille.IndexEmbosserProvider.EmbosserType.INDEX_BASIC_S_V3");
    private static IndexV3Embosser index_basic_d = (IndexV3Embosser)
            ec.get("com_indexbraille.IndexEmbosserProvider.EmbosserType.INDEX_BASIC_D_V3");
    private static IndexV3Embosser index_4x4pro = (IndexV3Embosser)
            ec.get("com_indexbraille.IndexEmbosserProvider.EmbosserType.INDEX_4X4_PRO_V3");
    private static IndexV3Embosser index_4waves = (IndexV3Embosser)
            ec.get("com_indexbraille.IndexEmbosserProvider.EmbosserType.INDEX_4WAVES_PRO_V3");

    private static PaperCatalog pc = PaperCatalog.newInstance();
    private static PageFormat a3 = new SheetPaperFormat(
        (SheetPaper) pc.get("org_daisy.ISO216PaperProvider.PaperSize.A3"),
        SheetPaperFormat.Orientation.DEFAULT
    );
    private static PageFormat a3_landscape = new SheetPaperFormat(
        (SheetPaper) pc.get("org_daisy.ISO216PaperProvider.PaperSize.A3"),
        SheetPaperFormat.Orientation.REVERSED
    );
    private static PageFormat papersize_210mm_12inch = new TractorPaperFormat(
        (TractorPaper) pc.get("org_daisy.TractorPaperProvider.PaperSize.W210MM_X_H12INCH")
    );
    private static PageFormat papersize_280mm_12inch = new TractorPaperFormat(
        (TractorPaper) pc.get("org_daisy.TractorPaperProvider.PaperSize.W280MM_X_H12INCH")
    );
    ...
    public void testPrintableArea() {
        ...
        assertEquals(
            "Assert that the absolute max width is 41 cells (4X4 Pro)",
            41,
            index_4x4pro.getMaxWidth(a3_landscape)
        );
        assertEquals(
            "Assert that the absolute max height is 29 lines (4X4 Pro)",
            29,
            index_4x4pro.getMaxHeight(a3_landscape)
        );

        index_4x4pro.setFeature(EmbosserFeatures.SADDLE_STITCH, true);

        assertEquals(
            "Assert that max width for a A3 paper is 34 cells (4X4 Pro, if saddle stitch mode is on)",
            index_4x4pro.getMaxWidth(a3_landscape),
            34
        );
    ...
    public void testDuplex() {
        ...
        assertTrue(
            "Assert that duplex is supported for " + index_4waves.getDisplayName(),
            index_4waves.supportsDuplex()
        );
    }
    ...
    public void test8dot() {
        ...
        assertTrue("Assert that 8-dot is not supported", !index_4waves.supports8dot());
    }
    ...
    public void testAligning() {
        ...
        assertTrue("Assert that aligning is supported", index_4waves.supportsAligning());
    }
    ...
    public void testEmbosserWriter() throws IOException,
        ...
        index_everest.setFeature(EmbosserFeatures.PAGE_FORMAT, a3);
        index_4x4pro.setFeature(EmbosserFeatures.PAGE_FORMAT, a3_landscape);
        ...
        FileIO.copy(
            this.getClass().getResourceAsStream("resource-files/basic_s_v3_single_sided.prn"),
        ...
        FileIO.copy(
            this.getClass().getResourceAsStream("resource-files/basic_d_v3_single_sided.prn"),
            new FileOutputStream(prn2)
        );
        new PEFConverterFacade(EmbosserCatalog.newInstance()).parsePefFile(pef, builder.build());
        try (InputStream is2 = new FileInputStream(prn2)) {
        ...
        FileIO.copy(
            this.getClass().getResourceAsStream("resource-files/basic_d_v3_zfolding_single_sided.prn"),
            new FileOutputStream(prn2)
        );
        new PEFConverterFacade(EmbosserCatalog.newInstance()).parsePefFile(pef, builder.build());
        try (InputStream is2 = new FileInputStream(prn2)) {
        ...
        FileIO.copy(
            this.getClass().getResourceAsStream("resource-files/basic_d_v3_double_sided.prn"),
            new FileOutputStream(prn2)
        );
        new PEFConverterFacade(EmbosserCatalog.newInstance()).parsePefFile(pef, builder.build());
        try (InputStream is2 = new FileInputStream(prn2)) {
        ...
        FileIO.copy(
            this.getClass().getResourceAsStream("resource-files/basic_d_v3_zfolding_double_sided.prn"),
            new FileOutputStream(prn2)
        );
        new PEFConverterFacade(EmbosserCatalog.newInstance()).parsePefFile(pef, builder.build());
        try (InputStream is2 = new FileInputStream(prn2)) {
        ...
        FileIO.copy(
            this.getClass().getResourceAsStream("resource-files/everest_v3_double_sided.prn"),
            new FileOutputStream(prn2)
        );
        new PEFConverterFacade(EmbosserCatalog.newInstance()).parsePefFile(pef, builder.build());
        try (InputStream is2 = new FileInputStream(prn2)) {
        ...
        FileIO.copy(
            this.getClass().getResourceAsStream("resource-files/4x4_pro_v3_double_sided.prn"),
            new FileOutputStream(prn2)
        );
        new PEFConverterFacade(EmbosserCatalog.newInstance()).parsePefFile(pef, builder.build());
        try (InputStream is2 = new FileInputStream(prn2)) {
        ...
        FileIO.copy(
            this.getClass().getResourceAsStream("resource-files/4x4_pro_v3_saddle_stitch.prn"),
            new FileOutputStream(prn2)
        );
        new PEFConverterFacade(EmbosserCatalog.newInstance()).parsePefFile(pef, builder.build());
        try (InputStream is2 = new FileInputStream(prn2)) {
