...
public abstract class AbstractTestBraillo200Embosser {
    ...
    public AbstractTestBraillo200Embosser(Embosser emb) {
        ...
        this.tractor_210mm_x_12inch = new TractorPaperFormat(
            pc.get("org_daisy.TractorPaperProvider.PaperSize.W210MM_X_H12INCH").asTractorPaper()
        );
        this.roll_a4 = new RollPaperFormat(
            pc.get("org_daisy.RollPaperProvider.PaperSize.W21CM").asRollPaper(),
            Length.newMillimeterValue(297)
        );
        this.emb = emb;
    ...
    public void performTest(String resource, String expPath) throws
            IOException,
        ...
        try {
            ...
            new PEFConverterFacade(
                EmbosserCatalog.newInstance()).parsePefFile(this.getClass().getResourceAsStream(resource),
                builder.build()
            );
