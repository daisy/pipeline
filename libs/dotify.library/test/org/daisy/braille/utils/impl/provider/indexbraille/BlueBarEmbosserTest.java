...
public class BlueBarEmbosserTest {
    ...
    private static BlueBarEmbosser e =
            (BlueBarEmbosser) ec.get("com_indexbraille.IndexEmbosserProvider.EmbosserType.INDEX_BASIC_BLUE_BAR");
    private static PaperCatalog pc = PaperCatalog.newInstance();
    private static PageFormat pagesize_210mm_12inch =
            new TractorPaperFormat((TractorPaper) pc.get("org_daisy.TractorPaperProvider.PaperSize.W210MM_X_H12INCH"));
    private static PageFormat pagesize_280mm_12inch =
    ...
    public void testPrintableArea() {
        ...
        assertEquals(
            "Assert that max width for a 210mm by 12 inch paper is 35 cells",
            e.getMaxWidth(pagesize_210mm_12inch),
            35
        );
        assertEquals(
            "Assert that max width for a 280mm by 12 inch paper is 46 cells",
            e.getMaxWidth(pagesize_280mm_12inch),
            46
        );
        assertEquals(
            "Assert that max height for a 280mm by 12 inch paper is 30 lines",
            e.getMaxHeight(pagesize_280mm_12inch),
            30
        );
    }
    ...
    public void testTableFilter() {
        ...
        assertTrue(
            ...
            tc.list(e.getTableFilter()).size() <= 1
        );
    }
    ...
    public void testEmbosserWriter() throws IOException,
        ...
        e.setFeature(EmbosserFeatures.PAGE_FORMAT, pagesize_280mm_12inch);
        ...
        FileIO.copy(this.getClass().getResourceAsStream(
            "resource-files/bluebar_single_sided.prn"),
