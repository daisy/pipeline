...
public class CapitalizationMarkersTest {
    ...
    public void testCaps001() {
        assertEquals(
            "",
            "⠠Det första exemplet är ⠠⠠SAV, bara ett ord.",
            f.filter("Det första exemplet är SAV, bara ett ord.")
        );
    }
    ...
    public void testCaps002() {
        assertEquals(
            "",
            "⠠Det andra exemplet är ⠠⠠⠠SAV VAS⠱, en ordgrupp.",
            f.filter("Det andra exemplet är SAV VAS, en ordgrupp.")
        );
    }
    ...
    public void testCaps003() {
        assertEquals(
            ...
            f.filter("LO/TCO / SACO:s Brysselkontor")
        );
    }
    ...
    public void testCaps020() {
        assertEquals(
            "",
            "⠠Det är sant: ⠠⠠⠠DETTA ÄR ETT TEST⠱. ⠠Inget annat.",
            f.filter("Det är sant: DETTA ÄR ETT TEST. Inget annat.")
        );
    }
    ...
    public void testCaps022() {
        assertEquals(
            "",
            "⠠Test av ⠠⠠STORA ⠠Bokstäver med flera ⠠⠠⠠ORD I RAD⠱, samt andra varianter, t.ex. lösenord som " +
                    "o⠠Ro⠠X⠠V⠠Q⠼5q och ⠠S ⠠P ⠠Ä ⠠R ⠠R ⠠A ⠠D text.",
            f.filter(
                "Test av STORA Bokstäver med flera ORD I RAD, samt andra varianter, t.ex. lösenord som " +
                "oRoXVQ⠼5q och S P Ä R R A D text."
            )
        );
    }
    ...
    public void testCaps023() {
        assertEquals(
            "",
            "⠠Flera ⠠⠠⠠R-O-L-I-G-A⠱ exempel.",
            f.filter("Flera R-O-L-I-G-A exempel.")
        );
    }
