...
public class SwedishBrailleTranslatorTest {
    private static final Logger logger = Logger.getLogger(SwedishBrailleTranslatorTest.class.getCanonicalName());
    private static final String TEST_INPUT_STRING_1 =
    ...
    public SwedishBrailleTranslatorTest() throws TranslatorConfigurationException {
        this.translator = new SwedishBrailleTranslatorFactory(
            HyphenatorFactoryMaker.newInstance()
        ).newTranslator("sv-SE", TranslatorType.UNCONTRACTED.toString());
    ...
    public void testTranslator() throws TranslationException {
        ...
        //Test
        assertEquals(
            "Assert that the output is translated.",
            "⠠⠎⠅⠊⠇⠇⠝⠁⠙⠑⠝\u2800⠍⠑⠇⠇⠁⠝\u2800⠁⠗⠃⠑⠞⠎\u2824\u2800⠕⠉⠓\u2800⠧⠊⠇⠕⠙⠁⠛⠁⠗\u2800" +
                    "⠃⠇⠑⠧\u2800⠍⠊⠝⠙⠗⠑\u2800⠎⠅⠁⠗⠏⠆\u2800⠓⠕⠝\u2800⠅⠥⠝⠙⠑\u2800⠞⠊⠇⠇⠡⠞⠁\u2800⠎⠊⠛\u2800" +
                    "⠧⠊⠇⠕⠙⠁⠛⠁⠗\u2800⠍⠊⠞⠞\u2800⠊\u2800⠧⠑⠉⠅⠁⠝⠄",
    ...
    public void testTranslatorAttributes_StyleBoldSingleWord() throws TranslationException {
        ...
        BrailleTranslatorResult btr = translator.translate(
            Translatable.text(TEST_INPUT_STRING_1).attributes(atts.build(105)).build()
        );
        assertEquals(
            "Assert that the style is translated.",
            "\u2828⠠⠎⠅⠊⠇⠇⠝⠁⠙⠑⠝\u2800⠍⠑⠇⠇⠁⠝\u2800⠁⠗⠃⠑⠞⠎\u2824\u2800⠕⠉⠓\u2800⠧⠊⠇⠕⠙⠁⠛⠁⠗\u2800" +
                    "⠃⠇⠑⠧\u2800⠍⠊⠝⠙⠗⠑\u2800⠎⠅⠁⠗⠏⠆\u2800⠓⠕⠝\u2800⠅⠥⠝⠙⠑\u2800⠞⠊⠇⠇⠡⠞⠁\u2800⠎⠊⠛\u2800" +
                    "⠧⠊⠇⠕⠙⠁⠛⠁⠗\u2800⠍⠊⠞⠞\u2800⠊\u2800⠧⠑⠉⠅⠁⠝⠄",
            btr.getTranslatedRemainder()
    ...
    public void testTranslatorAttributes_StyleBoldMultipleWords() throws TranslationException {
        ...
        BrailleTranslatorResult btr = translator.translate(
            Translatable.text(TEST_INPUT_STRING_1).attributes(atts.build(TEST_INPUT_STRING_1.length())).build()
        );
        assertEquals(
            "Assert that the style is translated.",
            "\u2828\u2828⠠⠎⠅⠊⠇⠇⠝⠁⠙⠑⠝\u2800⠍⠑⠇⠇⠁⠝\u2831\u2800⠁⠗⠃⠑⠞⠎\u2824\u2800⠕⠉⠓\u2800" +
    ...
    public void testTranslatorAttributes_DisallowedStructure() throws TranslationException {
        ...
        atts.add(1);
        BrailleTranslatorResult btr = translator.translate(
            Translatable.text(numeric).attributes(atts.build(numeric.length())).build()
        );
        logger.info(btr.getTranslatedRemainder());
    }
