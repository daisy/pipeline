...
abstract class BasicInteger2Text implements Integer2Text {
     ...
     * @throws UndefinedNumberException if the value cannot is not defined
     */
     ...
     *
     * @param value the number as text
     ...
     *
     * @param thousands the thousands as text
     * @param rem       the remainder as text
     * @return returns the formatted string
     */
     ...
     *
     * @param hundreds the hundreds as text
     * @param rem      the remainder as text
     * @return returns the formatted string
     */
