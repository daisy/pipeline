...
public interface PagedMediaWriterFactory {
     ...
     * @throws PagedMediaWriterConfigurationException if the media type is not supported
     */
     ...
     * @throws PagedMediaWriterConfigurationException if the feature is not supported
     */
