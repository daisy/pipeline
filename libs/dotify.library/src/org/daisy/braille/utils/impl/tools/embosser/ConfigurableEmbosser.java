...
public class ConfigurableEmbosser extends AbstractEmbosserWriter {
    ...
    public static class Builder {
        ...
        InternalEmbosserWriterProperties props =
                SimpleEmbosserProperties.with(Integer.MAX_VALUE, Integer.MAX_VALUE).build();
         ...
         * @return returns this object
         */
        public Builder header(byte[] value) {
            header = value;
            return this;
        }
         ...
         * @return returns this object
         */
        public Builder footer(byte[] value) {
            footer = value;
            return this;
        }
         ...
         * @return returns this object
         */
        public Builder fillSheet(boolean value) {
            fillSheet = value;
            return this;
        }
