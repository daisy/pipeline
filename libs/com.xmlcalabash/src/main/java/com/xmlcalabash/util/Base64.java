 ...
 *
 * <p>The <var>options</var> parameter, which appears in a few places, is used to pass
 ...
 *   options format (<var>int</var>s that you "OR" together).</li>
 *  <li>v1.5.1 - Fixed bug when decompressing and decoding to a
 *   byte[] using <var>decode( String s, boolean gzipCompressed )</var>.
...
/* ********  E N C O D I N G   M E T H O D S  ******** */
     ...
     * the method will return <var>null</var>.
...
//                    try{ bais.close(); } catch( Exception e ){}
     ...
     * Object within. Returns <var>null</var> if there was an error.
     *
...
//            try{ ois.close();  } catch( Exception e ){}
     ...
     * @return <var>true</var> if successful, <var>false</var> otherwise
     *
     * @since 2.1
     */
...
//            try{ bis.close(); } catch( Exception e) {}
    ...
    /**
     * Reads <var>infile</var> and encodes it to <var>outfile</var>.
     *
...
//            try{ out.close(); } catch( Exception exc ){}
    ...
    /**
     * Reads <var>infile</var> and decodes it to <var>outfile</var>.
     *
     * @param infile Input file
     * @param outfile Output file
     * @return true if the operation is successful
...
//            try{ out.close(); } catch( Exception exc ){}
     ...
     * <var>java.io.InputStream</var>, given in the constructor,
    ...
    public static class InputStream extends java.io.FilterInputStream
    {
         ...
         *
         * @param in the <var>java.io.InputStream</var> from which to read data.
         * @since 1.3
         */
     ...
     * <var>java.io.OutputStream</var>, given in the constructor,
     * and encode/decode to/from Base64 notation on the fly.
     *
     * @see Base64
     * @since 1.3
    ...
    public static class OutputStream extends java.io.FilterOutputStream
    {
         ...
         *
         * @param out the <var>java.io.OutputStream</var> to which data will be written.
         * @since 1.3
         */
