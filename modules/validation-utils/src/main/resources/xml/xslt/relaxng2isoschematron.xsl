...
<!--
	Stylesheet for extracting ISO Schematron information from a RELAX-NG schema.
	Based on the stylesheet for extracting Schematron information from W3C XML Schema.
	Created by Eddie Robertsson 2002/06/01, modded by Markus Gylling 20070330 to
	support ISO Schematron instead of pre-ISO Schematron
-->
