...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" version="1.0"
                ...
                type="px:ncx-update-links"
                name="main">

	<p:documentation xmlns="http://www.w3.org/1999/xhtml">
		<p>Update the links in a NCX document document after resources have been relocated.</p>
	</p:documentation>
	
	<p:input port="source" primary="true">
		<p:documentation xmlns="http://www.w3.org/1999/xhtml">
			<p>The input NCX</p>
			<p>If the NCX document itself is being relocated, the base URI of this document is
	...
	<p:output port="result">
		<p:documentation xmlns="http://www.w3.org/1999/xhtml">
			<p>The output NCX document with updated links</p>
		</p:documentation>
	</p:output>
