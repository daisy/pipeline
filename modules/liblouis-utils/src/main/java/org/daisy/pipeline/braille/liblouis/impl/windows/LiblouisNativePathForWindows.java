package org.daisy.pipeline.braille.liblouis.impl.windows;
...
@Component(
	name = "org.daisy.pipeline.braille.liblouis.impl.windows.LiblouisNativePathForWindows",
...
public class LiblouisNativePathForWindows extends BundledNativePath {
	...
	protected void activate(Map<?,?> properties) throws RuntimeException {
		activate(properties, LiblouisNativePathForWindows.class);
	}
}
