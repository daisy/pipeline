package org.daisy.pipeline.braille.liblouis.impl.linux;
...
@Component(
	name = "org.daisy.pipeline.braille.liblouis.impl.linux.LiblouisNativePathForLinux",
...
public class LiblouisNativePathForLinux extends BundledNativePath {
	...
	protected void activate(Map<?,?> properties) throws RuntimeException {
		activate(properties, LiblouisNativePathForLinux.class);
	}
}
