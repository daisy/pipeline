...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc" version="1.0"
	...
	<p:documentation xmlns="http://www.w3.org/1999/xhtml">
		<h1 px:role="name">DAISY 3 to MP3 (beta)</h1>
		<p px:role="desc">Transforms a DAISY 3 publication into a folder structure with MP3 files (beta).</p>
		<p><a px:role="homepage" href="http://daisy.github.io/pipeline/Get-Help/User-Guide/Scripts/daisy3-to-mp3/"
