...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <xsl:message>Move out inlined prodnotes</xsl:message>
        <xsl:apply-templates/>
    </xsl:template>
