...
public class NSC_EVENT_DATA_PhoSynch extends Structure {
	...
	protected List<? > getFieldOrder() {
		return Arrays.asList("uiSize", "pUserData", "cEngine_Phoneme", "uiIpa_Phoneme", "uiDuration", "uiByteCount");
	}
	/**
	 ...
	 */
	public NSC_EVENT_DATA_PhoSynch(int uiSize, Pointer pUserData, byte cEngine_Phoneme[], short uiIpa_Phoneme[], int uiDuration, int uiByteCount) {
		super();
		this.uiSize = uiSize;
	...
	public NSC_EVENT_DATA_PhoSynch(Pointer peer) {
		super(peer);
	}
	public static class ByReference extends NSC_EVENT_DATA_PhoSynch implements Structure.ByReference {
