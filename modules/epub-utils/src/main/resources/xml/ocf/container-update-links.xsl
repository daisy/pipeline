...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
                ...
                xpath-default-namespace="urn:oasis:names:tc:opendocument:xmlns:container"
    ...
    <!-- resolving happens one directory up from META-INF -->
    <xsl:variable name="doc-base" as="xs:string" select="resolve-uri('..',base-uri(/))"/>

    <xsl:template match="rootfile/@full-path|
                         link/@href">
        ...
        <xsl:variable name="resolved-file" as="xs:anyURI" select="resolve-uri($file,$doc-base)"/>
