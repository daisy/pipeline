...
public class BrailleCssCascader implements CssCascader {
	...
	protected void init() {
		...
		boolean warningsForUnsupportedButKnownProperties = true;
		/*
	...
	private static BrailleCssSerializer serializer = new BrailleCssSerializer();
