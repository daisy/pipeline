...
@Component(
	name = "org.daisy.pipeline.css.sass.impl.SassMapDatatypeService",
	service = {
		DatatypeService.class
	}
)
public class SassMapDatatypeService extends DatatypeService {

	private final Pattern pattern;
	private Document xmlDefinition = null;

	public SassMapDatatypeService() {
		super("sass-map");
		pattern = SassMapParser.asRegex();
	}
