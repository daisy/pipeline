...
public class VolatileJobStorageTest {
        ...
        public void setUp() {
                ...
                job1 = new VolatileJob(new AbstractJob(new Mock.MockedJobContext(cl, batchId1), Priority.MEDIUM, true) {});
                job2 = new VolatileJob(new AbstractJob(new Mock.MockedJobContext(cl, batchId2), Priority.MEDIUM, true) {});
                job1OtherCli = new VolatileJob(new AbstractJob(new Mock.MockedJobContext(clOther, batchId1), Priority.MEDIUM, true) {});
                job2OtherCli = new VolatileJob(new AbstractJob(new Mock.MockedJobContext(clOther, batchId2), Priority.MEDIUM, true) {});
        }
